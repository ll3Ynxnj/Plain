...
static const PLAColor kPLAColorTransparent = PLAColor(1.00, 1.00, 1.00, 0.00);
...
static const PLAColor kPLAColorOrange      = PLAColor(1.00, 0.50, 0.00, 1.00);
static const PLAColor kPLAColorSpringGreen = PLAColor(0.00, 1.00, 0.50, 1.00);
static const PLAColor kPLAColorViolet      = PLAColor(0.50, 0.00, 1.00, 1.00);
static const PLAColor kPLAColorLime        = PLAColor(0.50, 1.00, 0.00, 1.00);
static const PLAColor kPLAColorAzure       = PLAColor(0.00, 0.50, 1.00, 1.00);
static const PLAColor kPLAColorRose        = PLAColor(1.00, 0.00, 0.50, 1.00);
